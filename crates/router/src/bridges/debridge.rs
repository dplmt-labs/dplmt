    ...
    async fn quote(&self, request: &QuoteRequest) -> Result<BoothQuote, RouterError> {
        ...
        let mut req = self.client.get(url)
            .query(&[
                ...
                ("srcChainTokenIn", "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48".to_string()),
                ("dstChainTokenOut", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831".to_string()),
        ...
        let res = req.send().await.map_err(|e| RouterError::Upstream(e.to_string()))?;
        ...
        let amount_out_raw = data["estimation"]["dstChainTokenOut"]["amount"].as_str().unwrap_or("0");
